package com.atharv.guardiansafetyapp.features
...
import com.atharv.guardiansafetyapp.adapters.AddedContactsRVAdapter
import com.atharv.guardiansafetyapp.models.ContactNew
import com.atharv.guardiansafetyapp.viewmodel.GuardianAppViewModel
...
class AddedContactFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        view.findViewById<ImageView>(R.id.backtohome).setOnClickListener {
            view.findNavController().navigate(R.id.action_addedContactFragment_to_dashboardFragment)
        }
